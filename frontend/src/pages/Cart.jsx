...
const KEY = "pk_test_51K5wvyGFTqOA0lUt4y9WgXJlDaiqR2LbfBluWOXDFeUvOicxLLYI4REXebLDq2YCCDi6thx3L6WuvYMtEOd1p5g2006Rgmsvu1"
console.log('Key: ', KEY)
...
const Cart = () => {
  ...
  useEffect(()=>{
    try {
      userRequest.post('/checkout/payment', {tokenId: stripeToken.id, amount: carts.total*100, }).then(res=>{
        if(res.data){
        ...
        <Bottom>
          ...
          <Summary>
            ...
            <SummaryItem>
              ...
              <SummaryItemPrice>$ {carts.total}</SummaryItemPrice>
            </SummaryItem>
            <SummaryItem>
